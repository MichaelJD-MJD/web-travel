...
<body style="word-spacing:normal;background-color:#E4E6E8;">
  <div style="background-color:#E4E6E8;" lang="und" dir="auto">
                          ...
                          <tbody>
                            <tr>
                              <td style="width:100px;">
                                <img alt="" src="{{ url('frontend/images/logo/logo.png') }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="100" height="auto" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <div style="font-family:Assistant, Helvetica,Arial,Sans-serif;font-size:18px;line-height:28px;text-align:left;color:#071c4d;">Hi, {{ $data->user->name }} <br><br> Tiket digital kamu sudah berhasi dicetak. <br>Booking ID <strong>#{{ $data->id }}</strong></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                          <tr>
                            <td style="width: 50px"> <img src="{{ url('frontend/images/logo/logo-event.png') }}" width="50px" /> </td>
                            <td style="font-size=18px; padding-left: 10px; color:#071c4d; font-fa,mily: Assistang, Helvetica, Arial, sans-serif;"> support@mtravel.id <br> 021-1234-1234 </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistan, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888893;">2024 mtravel Copyright All Rights Reserved.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
